...
submit_job() {
    local env_name=$1
    local job_name="buffer_size_${env_name}"
    local seed=$2
    local buffer_size=$3
...
python -m fast_td3.train \
    --env_name ${env_name} \
    --exp_name fasttd3_${env_name}_buffer_${buffer_size} \
    --seed ${seed} \
    --num_envs 128 \
    --use_wandb \
...
submit_job "h1hand-hurdle-v0" "0" "1024"
submit_job "h1hand-hurdle-v0" "0" "10240"
