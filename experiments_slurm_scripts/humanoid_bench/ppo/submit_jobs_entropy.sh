...
python -m ppo.train \
    --env_name ${env_name} \
    --exp_name ppo_${env_name}_ent_${ent_coef} \
    --seed ${seed} \
    --use_wandb \
    --project "rl_scratch" \
    --num_envs 128 \
...
# submit_job "h1hand-hurdle-v0" "0" "0.001"
# submit_job "h1hand-hurdle-v0" "0" "0.0001"
submit_job "h1hand-hurdle-v0" "0" "0.0"
